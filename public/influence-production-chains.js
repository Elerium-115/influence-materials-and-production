...
const InfluenceProductionChainsJSON = {
    ...
    [
        ...
        {
            "id": "154",
            "name": "Core Sampler Drill",
            "type": "Component"
        },
        {
            "id": "155",
            "name": "Core Sampler Thruster",
            "type": "Component"
        },
        {
            "id": "156",
        ...
        {
            "id": "196",
            "name": "Hydrogen Heptafluorotantalate",
            "type": "Refined Material"
        },
        {
            "id": "197",
        ...
        {
            "id": "227",
            "name": "Lightbulb Upper End Moderator",
            "type": "Ship Component"
        },
        {
            "id": "228",
            "name": "Lightbulb Lower End Moderator",
            "type": "Ship Component"
        },
        {
            "id": "229",
    ...
    [
        ...
        {
            "id": "25",
            "name": "Enhanced Weathering Process",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "41",
            "name": "Steel Arc Furnace Smelting",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "49",
            "name": "Lead Smelting and Cupellation",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "54",
            "name": "Silica Centrifugal Atomization",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "57",
            "name": "Steel Beam Rolling Mill Process",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "58",
            "name": "Steel Sheet Rolling Mill Process",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "59",
            "name": "Steel Pipe Rolling Mill Process",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "63",
            "name": "Magnesium Molten Salt Electrolysis",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "65",
            "name": "Borax Fusion Furnace Process",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "71",
            "name": "Potassium Chloride Process",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "72",
            "name": "Olivine Leaching and Concentration",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "79",
            "name": "Merrilite Hot Acid Leaching",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "80",
            "name": "Rhabdite Arc Furnace Process",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "86",
            "name": "Silicon Czochralski Process",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "89",
            "name": "Chemical Granulation Process",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "91",
            "name": "Lithium Acid-Carbonate Process",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "92",
            "name": "Lithium Sulfate-Carbonate Process",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "99",
            "name": "Rare Earths Oxalation and Annealing",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "105",
            "name": "Yellowcake Dissolution and Solvent Extraction",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "107",
            "name": "Pyroxene Alkaline Pressure Digestion, Acidification, and Ion Exchange",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "111",
            "name": "Aluminium Beam Rolling Mill Process",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "112",
            "name": "Aluminium Sheet Rolling Mill Process",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "113",
            "name": "Aluminium Pipe Rolling Mill Process",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "115",
            "name": "Cold Gas Thruster Additive Manufacturing",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "116",
            "name": "Polyacrylonitrile Oxidation and Graphitization",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "119",
            "name": "Steel Ball Bearing Assembly",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "120",
            "name": "Steel Thrust Bearing Assembly",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "122",
            "name": "Lithium Chloride Electrolysis",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "126",
            "name": "Sodium Chromate Hot Acid Leaching and Crystallization",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "128",
            "name": "Molybdenum Trioxide Aluminothermic Reduction",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "129",
            "name": "Uranyl Nitrate Ammonolysis",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "130",
            "name": "Sodium Tungstate Crystallization",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "134",
            "name": "Core Sampler Drill Assembly",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "137",
            "name": "Photovoltaic Panel Assembly",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "140",
            "name": "Yttrium Oxide Fluoridation",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "141",
            "name": "Sodium Dichromate Carbothermic Reduction",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "142",
            "name": "Photoresist Epoxy Stiochiometry and Packaging",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "143",
            "name": "Ammonium Diuranate Reduction",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "144",
            "name": "Ammonium Paratungstate Calcining and Reduction",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "156",
            "name": "Tungsten Centrifugal Atomization",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "158",
            "name": "Stainless Steel Sheet Rolling Mill Process",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "159",
            "name": "Stainless Steel Pipe Rolling Mill Process",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "160",
            "name": "Silicon Wafer Photolithography and Etching",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "162",
            "name": "Neodymium(III) Chloride Vacuum Heating",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "163",
            "name": "Neodymium(III) Chloride Molten Salt Electrolysis",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "164",
            "name": "Yttrium Fluoride Reduction",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "172",
            "name": "Uranium Hexafluoride Centrifuge Cascade",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "175",
            "name": "HEUF6 Reduction and Fine Division",
            "buildingId": "4",
            "inputs":
            [
                {
        ...
        {
            "id": "178",
            "name": "Ethylene Hydrovinylation, Hydration, and Dehydrogenation",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "183",
            "name": "Rhabdite Leaching and Concentration",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "184",
            "name": "Sodium Bisulfate Electrolytic Oxidation",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "186",
            "name": "Hydrogen Heptafluorotantalate Redox and Molten Salt Reduction",
            "buildingId": "3",
            "inputs":
            [
                {
        ...
        {
            "id": "214",
            "name": "Upper End Moderator Assembly",
            "buildingId": "5",
            "inputs":
            [
                {
        ...
        {
            "id": "215",
            "name": "Lower End Moderator Assembly",
            "buildingId": "5",
            "inputs":
            [
                {
